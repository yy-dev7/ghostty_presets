...
" Markdown - match bat's Catppuccin Mocha rendering
call s:hi("markdownH1", "NONE", s:red, "NONE", "bold", "bold")
call s:hi("markdownH2", "NONE", s:green, "NONE", "bold", "bold")
call s:hi("markdownH3", "NONE", s:teal, "NONE", "bold", "bold")
call s:hi("markdownH4", "NONE", s:yellow, "NONE", "bold", "bold")
call s:hi("markdownH5", "NONE", s:mauve, "NONE", "bold", "bold")
call s:hi("markdownH6", "NONE", s:blue, "NONE", "bold", "bold")
call s:hi("markdownH1Delimiter", "NONE", s:overlay2, "NONE", "NONE", "NONE")
call s:hi("markdownH2Delimiter", "NONE", s:overlay2, "NONE", "NONE", "NONE")
call s:hi("markdownH3Delimiter", "NONE", s:overlay2, "NONE", "NONE", "NONE")
call s:hi("markdownH4Delimiter", "NONE", s:overlay2, "NONE", "NONE", "NONE")
call s:hi("markdownH5Delimiter", "NONE", s:overlay2, "NONE", "NONE", "NONE")
call s:hi("markdownH6Delimiter", "NONE", s:overlay2, "NONE", "NONE", "NONE")
call s:hi("markdownBold", "NONE", s:red, "NONE", "bold", "bold")
call s:hi("markdownBoldDelimiter", "NONE", s:red, "NONE", "NONE", "NONE")
call s:hi("markdownItalic", "NONE", s:maroon, "NONE", "italic", "italic")
call s:hi("markdownItalicDelimiter", "NONE", s:maroon, "NONE", "NONE", "NONE")
call s:hi("markdownCode", "NONE", s:green, "NONE", "NONE", "NONE")
call s:hi("markdownCodeDelimiter", "NONE", s:overlay2, "NONE", "NONE", "NONE")
call s:hi("markdownCodeBlock", "NONE", s:green, "NONE", "NONE", "NONE")
call s:hi("markdownUrl", "NONE", s:blue, "NONE", "underline", "underline")
call s:hi("markdownLinkText", "NONE", s:blue, "NONE", "NONE", "NONE")
call s:hi("markdownLinkDelimiter", "NONE", s:overlay2, "NONE", "NONE", "NONE")
call s:hi("markdownLinkTextDelimiter", "NONE", s:overlay2, "NONE", "NONE", "NONE")
call s:hi("markdownListMarker", "NONE", s:teal, "NONE", "NONE", "NONE")
call s:hi("markdownRule", "NONE", s:overlay2, "NONE", "NONE", "NONE")
